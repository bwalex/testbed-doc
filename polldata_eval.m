%[node_rtt, node_s2dt, node_retries, node_fails, avg_rtt, avg_s2dt, node_oobs, node_timeouts seq_id] = polldata_eval(2, polldata_1)
function [node_rtt, node_s2dt, node_retries, node_fails, avg_rtt, avg_s2dt, node_oobs, node_timeouts seq_id] = polldata_eval(node, polldata_1)
   node_rtt = [];
   node_s2dt = [];
   node_retries = 0;
   node_fails = 0;
